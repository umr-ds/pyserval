...
def test_send_message(serval_init, payload):
    ...
    meshms.send_message(sender=identities[0], recipient=identities[1], message=payload)

    messages_new = meshms.message_list(sender=identities[0], recipient=identities[1])
